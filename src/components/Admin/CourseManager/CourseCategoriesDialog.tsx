...
export function CourseCategoriesDialog({
  ...
  const { data: courseCategories, isLoading: isLoadingCourseCategories } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await apiClient.get('/api/admin/course_categories', { params: { course_id: courseId } });
  ...
  const { data: availableCategories, isLoading: isLoadingCategories } = useQuery({
    ...
    queryFn: async () => {
      const { data: existingCategoryIds } = await apiClient.get(`/api/admin/course_categories`, { params: { course_id: courseId } });
  ...
  const addCategoriesMutation = useMutation({
    mutationFn: async (categoryIds: string[]) => {
      ...
      const { error } = await apiClient.post('/api/admin/course_categories', newCourseCategories);
  ...
  const removeCategoryMutation = useMutation({
    mutationFn: async (id: string) => {
      const { error } = await apiClient.delete(`/api/admin/course_categories/${id}`);
