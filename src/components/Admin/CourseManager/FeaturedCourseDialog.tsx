...
export function FeaturedCourseDialog({ 
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      if (isEditing) {
        const { error } = await apiClient.put(`/api/admin/featured_courses/${featuredCourse.id}`, {
        ...
        const { data: maxOrderCourse, error: orderError } = await apiClient.get('/api/admin/featured_courses');
