                    ...
                    render={({ field }) => (
                      <FormItem className="space-y-3">
                        ...
                        <FormControl>
                          ...
                          >
                            <div className={`flex items-center space-x-2 border rounded-lg p-3 cursor-pointer ${field.value === 'student' ? 'border-purple-500 bg-purple-50' : 'border-gray-200'
                              }`}>
                            ...
                            <div className={`flex items-center space-x-2 border rounded-lg p-3 cursor-pointer ${field.value === 'teacher' ? 'border-purple-500 bg-purple-50' : 'border-gray-200'
                              }`}>
