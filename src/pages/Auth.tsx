...
const Auth = () => {
  ...
  const processReferralSignup = async (newUserId: string) => {
    ...
    try {
      // const { data, error } = await apiClient.rpc('process_referral_signup', {
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      ...
                      <FormControl>
                        ...
                        >
                          <div className={`flex items-center space-x-2 border rounded-lg p-4 cursor-pointer ${field.value === 'student' ? 'border-purple-500 bg-purple-50' : 'border-gray-200'
                            }`}>
                          ...
                          <div className={`flex items-center space-x-2 border rounded-lg p-4 cursor-pointer ${field.value === 'teacher' ? 'border-purple-500 bg-purple-50' : 'border-gray-200'
                            }`}>
