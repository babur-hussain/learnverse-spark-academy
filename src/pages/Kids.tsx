...
const Kids = () => {
  ...
  const fetchCategories = async () => {
    try {
      const { data, error } = await apiClient.get(`/api/admin/kids_content_categories`, { params: { is_active: true } });
  ...
  const fetchContentItems = async () => {
    try {
      const { data, error } = await apiClient.get(`/api/admin/kids_content_items`, { params: { is_active: true } });
