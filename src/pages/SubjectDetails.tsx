...
const SubjectDetails = () => {
  ...
  const { data: chapters = [], isLoading: chaptersLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data } = await apiClient.get(`/api/admin/chapters`, { params: { subject_id: subjectId } });
  ...
  const { data: resources = [] } = useQuery({
    ...
    queryFn: async () => {
      ...
      const { data } = await apiClient.get(`/api/admin/subject_resources`, { params: { subject_id: subjectId } });
  ...
  const deleteChapterMutation = useMutation({
    mutationFn: async (chapterId: string) => {
      ...
      const { data: chapterResources } = await apiClient.get(`/api/admin/subject_resources`, { params: { chapter_id: chapterId } });
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-6 mb-8">
            ...
            <div className="relative w-full h-48 md:h-64 bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl mb-6 flex items-center justify-center overflow-hidden">
              {subject.thumbnail_url ? (
                ...
                <div className="text-center">
                  ...
                  <div className="text-2xl font-bold text-indigo-600">{subject.title || subject.name}</div>
                </div>
              )}
              {/* Play Button Overlay */}
            ...
            <div className="text-center mb-6">
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">{subject.title || subject.name}</h1>
              {subject.description && (
