...
const ChapterContentManagement = () => {
  ...
  const { data: subject } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await apiClient.get(`/api/admin/subjects`, { params: { id: subjectId } });
  ...
  const { data: chapter } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await apiClient.get(`/api/admin/chapters`, { params: { id: chapterId } });
