...
export const CouponInput: React.FC<CouponInputProps> = ({
  ...
  const validateAndApplyCoupon = async () => {
    ...
    setLoading(true);
    try {
      const { data: coupon, error } = await apiClient.get(`/api/admin/coupons`, { params: { code: couponCode.toUpperCase(), is_active: true } })
      ...
      const { data: usage } = await apiClient.get(`/api/admin/coupon_usage`, { params: { coupon_id: couponData.id } });
