...
import { ArrowLeftToLine, ArrowRightToLine, ChevronLeft, ChevronRight, ChevronDown, Menu, X } from "lucide-react";
...
// Generic Slot component for component composition
const Slot = React.forwardRef<HTMLElement, React.HTMLAttributes<HTMLElement>>(
  ({ children, ...props }, ref) => {
    ...
    // Pass the ref and props to the first child
...
const SidebarMenuButton = React.forwardRef<
  ...
  React.ComponentProps<"button"> & {
    asChild?: boolean;
    isActive?: boolean;
    tooltip?: string | { content: string; [key: string]: any };
